          ...
          >
            <div className="flex flex-col gap-7 ">
              <WhatWeDoCard
                ...
                title={"قابل اطمینان"}
                desc={
                  "با تکیه بر دانش تخصصی، تجربه عملی و تعهد به شفافیت، راهکارهایی مطمئن و پایدار در حوزه پیرولیز پسماند ارائه می‌کنیم."
                }
              />
              <WhatWeDoCard
                ...
                desc={
                  "تیم متخصص ما با مشاوره تخصصی، پاسخگویی سریع و همراهی مستمر، در تمام مراحل کنار شما خواهد بود."
                }
              />
            </div>
            <div className="flex flex-col gap-7">
              ...
              <WhatWeDoCard
                ...
                title={"کیفیت بالا"}
                desc={
                  "از طراحی تا اجرا، کیفیت، بهره‌وری و رعایت استانداردهای فنی در تمامی مراحل فعالیت ما در اولویت قرار دارد."
                }
              />
              <div
                style={{ height: 130 }}
